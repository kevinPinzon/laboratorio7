...
virtual string GestionCasos::toString ()const{
	stringstream ss;
	ss<<" Numero de caso "<<numero<<" Investigadores: "<<investigadores<<" Evidencia: "<<envidencia<<" Hora: "hora<< " Caso: "caso ;
	return ss.str();
}
